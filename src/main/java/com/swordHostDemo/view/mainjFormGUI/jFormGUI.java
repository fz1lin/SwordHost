...
public class jFormGUI extends JFrame {
    ...
    public void windowStartInit() {
        ...
        try {
            //查询数据库值
            menuDataService.selectData(LhostValue, LportValue, DNSlogValue, HTTPPortValue, LDAPPortVaule, CommandVaule, FileNameVaule);
        } catch (Exception e) {
            e.printStackTrace();
        }
...
//
    ...
    public void saveMenuData() {
        menuCurdDaoImpl menuDataService = new menuCurdDaoImpl();
        try {
            menuDataService.addData(LhostValue, LportValue, DNSlogValue, HTTPPortValue, LDAPPortVaule, CommandVaule, FileNameVaule);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void menuKeyInit() {
        ...
        menuBeanListener.setHTTPPort(HTTPPortValue.getText());
        menuBeanListener.setLDAPPort(LDAPPortVaule.getText());
        ...
        menuReverseService.reverseBashOptionsMenu(Bash1TextArea,
                Bash2TextArea, Bash3TCPTextField, Bash1UDPTextField, Bash2UDPTextField, BashTCP4TextField);
        menuReverseService.reverseAwkOptionsMenu(ReverseAwkTextField);


        //menuRceService
        menuRceServiceImpl menuRceService = new menuRceServiceImpl();
        menuRceService.rceMenu(Curl1TextField, Curl2TextField, Wget1TextArea, PythonTextArea,CatListenerTextField,CatAttackTextField);
        //python2 server
        Python2ServerTextField.setText(RceController.python2Server());
        //python3 server
        Python3ServerTextField.setText(RceController.python3Server());
        ...
        menuJavaService.JndiMenu(JNDIExploitTextField,JNDValueITextArea);
...
//        JNDValueITextArea.setText(JNDIExploitControler.JavaBytecodeExec());
    ...
    private void RhostValueKeyReleased(KeyEvent e) {
        // TODO add your code here
        //测试
        System.out.println("GUI-rhost：" + HTTPPortValue.getText());
        //调用方法
        menuKeyInit();
    }
    ...
    private void RportVauleKeyReleased(KeyEvent e) {
        //测试
        System.out.println("GUI-rport：" + LDAPPortVaule.getText());
        //调用方法
        menuKeyInit();
    ...
    private void HistoryRhostValueJListMouseClicked(MouseEvent e) {
        ...
        HTTPPortValue.setText(selectedValue);
        menuKeyInit();
    }
    ...
    private void HistoryRportValueJListMouseClicked(MouseEvent e) {
        ...
        LDAPPortVaule.setText(selectedValue);
        menuKeyInit();
    }
    ...
    private void saveMenuButtonMouseClicked(MouseEvent e) {
        ...
        } else if (!regularUtls.rePort(HTTPPortValue.getText())) {
            JOptionPane.showMessageDialog(null, "保存失败！ HTTP Port 输入非法！\r\n路径：Java->JNDI\r\n范围：1~65535", "提示", JOptionPane.ERROR_MESSAGE);
        } else if (!regularUtls.rePort(LDAPPortVaule.getText()) || LDAPPortVaule.getText() == null) {
            JOptionPane.showMessageDialog(null, "保存失败！ LDAP Port 输入非法！\r\n路径：Java->JNDI\r\n范围：1~65535", "提示", JOptionPane.ERROR_MESSAGE);
    ...
    private void ReInputVauletextAreaCaretUpdate(CaretEvent e) {
        ...
        ReIPPortFTextArea.setText("");
        List<String> result = regularUtls.IPAndPortExtractor(text, 1, 65535);
    ...
    private void JNDIJavaBytecodeExecButtonMouseClicked(MouseEvent e) {
        // TODO add your code here
        JNDValueITextArea.setText(JNDIExploitControler.JavaBytecodeExec());
    }

    private void JNDITomcatBypassButtonMouseClicked(MouseEvent e) {
        // TODO add your code here
        JNDValueITextArea.setText(JNDIExploitControler.tomcatBypass());

    }

    private void JNDIOtherFactoryBypassButtonMouseClicked(MouseEvent e) {
        // TODO add your code here
        JNDValueITextArea.setText(JNDIExploitControler.otherFactoryBypass());
    }

    private void JNDIDeserializationButtonMouseClicked(MouseEvent e) {
        // TODO add your code here
        JNDValueITextArea.setText(JNDIExploitControler.Deserialization());

    }

    private void JNDIGithubButtonMouseClicked(MouseEvent e) {
        // TODO add your code here
        copyEchoText.init("https://github.com/zzwlpx/JNDIExploit");
    }

    private void BashTCP4ButtonMouseClicked(MouseEvent e) {
        // TODO add your code here
        copyEchoText.init(BashTCP4TextField.getText());
    }

    private void ReInputValueURLTextAreaCaretUpdate(CaretEvent e) {
        // TODO add your code here
        ReOutputIPTextArea.setText("");
        ReOuputURLTextArea.setText("");

        HashMap<Integer, String> ip = regularUtls.reUtlsHashMap(regularUtls.REHOST, ReInputValueURLTextArea.getText());

        // 输出 key 和 value
        for (String values : ip.values()) {
            // 输出每一个value
            ReOutputIPTextArea.append(values + "\n");
        }
        HashMap<Integer, String> url = regularUtls.reUtlsHashMap(regularUtls.REurl, ReInputValueURLTextArea.getText());
        // 输出 key 和 value
        for (String value : url.values()) {
            // 输出每一个value
            ReOuputURLTextArea.append(value + "\n");
        }
    }

    private void ReURLIPresetButtonMouseClicked(MouseEvent e) {
        ReOutputIPTextArea.setText("");
        ReOuputURLTextArea.setText("");
        ReInputValueURLTextArea.setText("");
    }

    private void ReIPsetButtonMouseClicked(MouseEvent e) {
        // TODO add your code here
        String values = ReInputValueURLTextArea.getText();
        regularUtls.reQuChongHashMap(regularUtls.REHOST, values, ReOutputIPTextArea);
        regularUtls.reQuChongHashMap(regularUtls.REurl, values, ReOuputURLTextArea);

    }

    private void ReOuputIPCopyButtonMouseClicked(MouseEvent e) {
        // TODO add your code here
        copyEchoText.init(ReOutputIPTextArea.getText());
    }

    private void ReOuputURLCopyButtonMouseClicked(MouseEvent e) {
        // TODO add your code here
        copyEchoText.init(ReOuputURLTextArea.getText());
    }
    ...
    private void initComponents() {
        ...
        button5 = new JButton();
        label89 = new JLabel();
        BashTCP4TextField = new JTextField();
        BashTCP4Button = new JButton();
        ...
        label87 = new JLabel();
        Python2ServerTextField = new JTextField();
        label88 = new JLabel();
        Python3ServerTextField = new JTextField();
        CurlOptionsPanel = new JPanel();
        label6 = new JLabel();
        ...
        CatListenerTextField = new JTextField();
        label93 = new JLabel();
        label94 = new JLabel();
        CatAttackTextField = new JTextField();
        ...
        JNDValueITextArea = new JTextArea();
        JNDIJavaBytecodeExecButton = new JButton();
        JNDIExploitTextField = new JTextField();
        label80 = new JLabel();
        label86 = new JLabel();
        HistoryRhostListScrollPane = new JScrollPane();
        HistoryRhostValueJList = new JList();
        HTTPPortValue = new JTextField();
        LDAPPortVaule = new JTextField();
        ...
        JNDIDeserializationButton = new JButton();
        JNDITomcatBypassButton = new JButton();
        JNDIOtherFactoryBypassButton = new JButton();
        JNDIGithubButton = new JButton();
        REs = new JPanel();
        ...
        ReInputValueURLTextArea = new JTextArea();
        scrollPane22 = new JScrollPane();
        ReOuputURLTextArea = new JTextArea();
        scrollPane23 = new JScrollPane();
        ReOutputIPTextArea = new JTextArea();
        ReIPsetButton = new JButton();
        ReURLIPresetButton = new JButton();
        label90 = new JLabel();
        label91 = new JLabel();
        label92 = new JLabel();
        ReOuputIPCopyButton = new JButton();
        ReOuputURLCopyButton = new JButton();
        ...
        //======== inputValuePanels ========
        {
            inputValuePanels.setLayout(null);

            //---- LHOST ----
            LHOST.setText(bundle.getString("LHOST.text"));
            inputValuePanels.add(LHOST);
            LHOST.setBounds(30, 10, 55, LHOST.getPreferredSize().height);

            //---- LPORT ----
            LPORT.setText("LPORT");
            inputValuePanels.add(LPORT);
            LPORT.setBounds(265, 10, 55, LPORT.getPreferredSize().height);
            ...
            inputValuePanels.add(LhostValue);
            LhostValue.setBounds(90, 5, 130, LhostValue.getPreferredSize().height);
            ...
            inputValuePanels.add(LportValue);
            LportValue.setBounds(320, 5, 75, LportValue.getPreferredSize().height);

            //---- DNSLog ----
            DNSLog.setText("DNSLog");
            inputValuePanels.add(DNSLog);
            DNSLog.setBounds(435, 10, 65, DNSLog.getPreferredSize().height);
            ...
            inputValuePanels.add(DNSlogValue);
            DNSlogValue.setBounds(495, 5, 130, DNSlogValue.getPreferredSize().height);

            //---- FileName ----
            FileName.setText("FileName");
            inputValuePanels.add(FileName);
            FileName.setBounds(660, 10, 70, 17);
            ...
            inputValuePanels.add(FileNameVaule);
            FileNameVaule.setBounds(725, 5, 130, 30);
            ...
            inputValuePanels.add(HistoryLhostListScrollPane);
            HistoryLhostListScrollPane.setBounds(90, 30, 130, 70);
            ...
            inputValuePanels.add(HistoryLportListScrollPane);
            HistoryLportListScrollPane.setBounds(320, 30, 75, 70);
            ...
            inputValuePanels.add(HistoryDnslogListScrollPane);
            HistoryDnslogListScrollPane.setBounds(495, 30, 130, 70);
            ...
            inputValuePanels.add(HistoryFilenameListScrollPane);
            HistoryFilenameListScrollPane.setBounds(725, 30, 130, 65);

            {
                // compute preferred size
                Dimension preferredSize = new Dimension();
                for(int i = 0; i < inputValuePanels.getComponentCount(); i++) {
                    Rectangle bounds = inputValuePanels.getComponent(i).getBounds();
                    preferredSize.width = Math.max(bounds.x + bounds.width, preferredSize.width);
                    preferredSize.height = Math.max(bounds.y + bounds.height, preferredSize.height);
                }
                Insets insets = inputValuePanels.getInsets();
                preferredSize.width += insets.right;
                preferredSize.height += insets.bottom;
                inputValuePanels.setMinimumSize(preferredSize);
                inputValuePanels.setPreferredSize(preferredSize);
            }
        }
        contentPane.add(inputValuePanels);
        inputValuePanels.setBounds(10, 40, 885, inputValuePanels.getPreferredSize().height);
        ...
        //======== OptionsPanels ========
        {
            ...
            //======== ReverseMenu ========
            {
                ...
                //======== BashOptions ========
                {
                    ...
                    Bash1UDPTextField.setBounds(20, 285, 565, Bash1UDPTextField.getPreferredSize().height);
                    BashOptions.add(Bash2UDPTextField);
                    Bash2UDPTextField.setBounds(20, 355, 565, Bash2UDPTextField.getPreferredSize().height);

                    //---- label84 ----
                    label84.setText(bundle.getString("label84.text"));
                    BashOptions.add(label84);
                    label84.setBounds(new Rectangle(new Point(25, 260), label84.getPreferredSize()));

                    //---- label85 ----
                    label85.setText(bundle.getString("label85.text"));
                    BashOptions.add(label85);
                    label85.setBounds(new Rectangle(new Point(20, 325), label85.getPreferredSize()));

                    //---- button2 ----
                    button2.setText(bundle.getString("button2.text"));
                    BashOptions.add(button2);
                    button2.setBounds(new Rectangle(new Point(605, 285), button2.getPreferredSize()));

                    //---- button5 ----
                    button5.setText(bundle.getString("button5.text"));
                    BashOptions.add(button5);
                    button5.setBounds(new Rectangle(new Point(600, 360), button5.getPreferredSize()));

                    //---- label89 ----
                    label89.setText(bundle.getString("label89.text"));
                    BashOptions.add(label89);
                    label89.setBounds(new Rectangle(new Point(25, 185), label89.getPreferredSize()));
                    BashOptions.add(BashTCP4TextField);
                    BashTCP4TextField.setBounds(20, 210, 565, BashTCP4TextField.getPreferredSize().height);

                    //---- BashTCP4Button ----
                    BashTCP4Button.setText(bundle.getString("BashTCP4Button.text"));
                    BashTCP4Button.addMouseListener(new MouseAdapter() {
                        @Override
                        public void mouseClicked(MouseEvent e) {
                            BashTCP4ButtonMouseClicked(e);
                        }
                    });
                    BashOptions.add(BashTCP4Button);
                    BashTCP4Button.setBounds(new Rectangle(new Point(610, 210), BashTCP4Button.getPreferredSize()));
            ...
            OptionsPanels.addTab(bundle.getString("ReverseMenu.tab.title"), ReverseMenu);
            ...
            //======== RCEMenu ========
            {
                ...
                //======== CurlOption ========
                {
                    ...
                    //======== PythonOption ========
                    {
                        ...
                        scrollPane12.setBounds(25, 220, 665, 145);

                        //---- label87 ----
                        label87.setText(bundle.getString("label87.text"));
                        PythonOption.add(label87);
                        label87.setBounds(new Rectangle(new Point(20, 25), label87.getPreferredSize()));
                        PythonOption.add(Python2ServerTextField);
                        Python2ServerTextField.setBounds(25, 50, 490, Python2ServerTextField.getPreferredSize().height);

                        //---- label88 ----
                        label88.setText(bundle.getString("label88.text"));
                        PythonOption.add(label88);
                        label88.setBounds(new Rectangle(new Point(25, 95), label88.getPreferredSize()));
                        PythonOption.add(Python3ServerTextField);
                        Python3ServerTextField.setBounds(25, 130, 490, Python3ServerTextField.getPreferredSize().height);
                    ...
                    //======== CurlOptionsPanel ========
                    {
                        CurlOptionsPanel.setLayout(null);

                        //---- label6 ----
                        label6.setText(bundle.getString("label6.text"));
                        CurlOptionsPanel.add(label6);
                        label6.setBounds(new Rectangle(new Point(20, 35), label6.getPreferredSize()));
                        CurlOptionsPanel.add(Curl2TextField);
                        Curl2TextField.setBounds(20, 150, 645, 30);

                        //---- label8 ----
                        label8.setText(bundle.getString("label8.text"));
                        CurlOptionsPanel.add(label8);
                        label8.setBounds(20, 125, 43, 17);
                        CurlOptionsPanel.add(Curl1TextField);
                        Curl1TextField.setBounds(20, 85, 645, 30);

                        //---- label7 ----
                        label7.setText(bundle.getString("label7.text"));
                        CurlOptionsPanel.add(label7);
                        label7.setBounds(20, 60, 43, 17);

                        //---- label9 ----
                        label9.setText(bundle.getString("label9.text"));
                        CurlOptionsPanel.add(label9);
                        label9.setBounds(20, 5, 105, 30);

                        {
                            // compute preferred size
                            Dimension preferredSize = new Dimension();
                            for(int i = 0; i < CurlOptionsPanel.getComponentCount(); i++) {
                                Rectangle bounds = CurlOptionsPanel.getComponent(i).getBounds();
                                preferredSize.width = Math.max(bounds.x + bounds.width, preferredSize.width);
                                preferredSize.height = Math.max(bounds.y + bounds.height, preferredSize.height);
                            }
                            Insets insets = CurlOptionsPanel.getInsets();
                            preferredSize.width += insets.right;
                            preferredSize.height += insets.bottom;
                            CurlOptionsPanel.setMinimumSize(preferredSize);
                            CurlOptionsPanel.setPreferredSize(preferredSize);
                        }
                    }
                    CurlOption.addTab(bundle.getString("CurlOptionsPanel.tab.title_2"), CurlOptionsPanel);

                    //======== CatOptions ========
                    {
                        CatOptions.setLayout(null);
                        CatOptions.add(CatListenerTextField);
                        CatListenerTextField.setBounds(20, 50, 455, CatListenerTextField.getPreferredSize().height);

                        //---- label93 ----
                        label93.setText(bundle.getString("label93.text"));
                        CatOptions.add(label93);
                        label93.setBounds(new Rectangle(new Point(25, 20), label93.getPreferredSize()));

                        //---- label94 ----
                        label94.setText(bundle.getString("label94.text"));
                        CatOptions.add(label94);
                        label94.setBounds(new Rectangle(new Point(20, 105), label94.getPreferredSize()));
                        CatOptions.add(CatAttackTextField);
                        CatAttackTextField.setBounds(20, 135, 455, CatAttackTextField.getPreferredSize().height);

                        {
                            // compute preferred size
                            Dimension preferredSize = new Dimension();
                            for(int i = 0; i < CatOptions.getComponentCount(); i++) {
                                Rectangle bounds = CatOptions.getComponent(i).getBounds();
                                preferredSize.width = Math.max(bounds.x + bounds.width, preferredSize.width);
                                preferredSize.height = Math.max(bounds.y + bounds.height, preferredSize.height);
                            }
                            Insets insets = CatOptions.getInsets();
                            preferredSize.width += insets.right;
                            preferredSize.height += insets.bottom;
                            CatOptions.setMinimumSize(preferredSize);
                            CatOptions.setPreferredSize(preferredSize);
                        }
                    }
                    CurlOption.addTab(bundle.getString("CatOptions.tab.title_2"), CatOptions);
                }
                RCEMenu.add(CurlOption);
                CurlOption.setBounds(0, 0, 945, 435);
            ...
            OptionsPanels.addTab(bundle.getString("RCEMenu.tab.title"), RCEMenu);
            ...
            //======== msfs ========
            {
                ...
                //======== msfRootOptions ========
                {
                    ...
                    msfCopyRootButton.setBounds(new Rectangle(new Point(355, 35), msfCopyRootButton.getPreferredSize()));

                    //---- label29 ----
                    label29.setText(bundle.getString("label29.text"));
                    msfRootOptions.add(label29);
                    label29.setBounds(new Rectangle(new Point(25, 75), label29.getPreferredSize()));
                    ...
                    msfCopyRootButton2.setBounds(new Rectangle(new Point(475, 265), msfCopyRootButton2.getPreferredSize()));
                    ...
                    msfPayloadCopyTextField.setBounds(100, 100, 370, msfPayloadCopyTextField.getPreferredSize().height);
            ...
            OptionsPanels.addTab(bundle.getString("msfs.tab.title"), msfs);
            ...
            OptionsPanels.addTab(bundle.getString("Stoways.tab.title"), Stoways);
            ...
            //======== JavaMenu ========
            {
                ...
                //======== tabbedPane4 ========
                {
                    ...
                    //======== FaEXP1Options ========
                    {
                        ...
                        FaEXP1.setBounds(10, 10, 770, 325);
                        ...
                        FaCopyEXP1TextArea.setBounds(new Rectangle(new Point(10, 350), FaCopyEXP1TextArea.getPreferredSize()));
                    ...
                    //======== panel1 ========
                    {
                        ...
                        //======== scrollPane20 ========
                        {
                            scrollPane20.setViewportView(JNDValueITextArea);
                        }
                        panel1.add(scrollPane20);
                        scrollPane20.setBounds(15, 135, 685, 300);

                        //---- JNDIJavaBytecodeExecButton ----
                        JNDIJavaBytecodeExecButton.setText(bundle.getString("JNDIJavaBytecodeExecButton.text"));
                        JNDIJavaBytecodeExecButton.addMouseListener(new MouseAdapter() {
                            @Override
                            public void mouseClicked(MouseEvent e) {
                                JNDIJavaBytecodeExecButtonMouseClicked(e);
                            }
                        });
                        panel1.add(JNDIJavaBytecodeExecButton);
                        JNDIJavaBytecodeExecButton.setBounds(new Rectangle(new Point(510, 15), JNDIJavaBytecodeExecButton.getPreferredSize()));
                        panel1.add(JNDIExploitTextField);
                        JNDIExploitTextField.setBounds(15, 105, 560, JNDIExploitTextField.getPreferredSize().height);

                        //---- label80 ----
                        label80.setText(bundle.getString("label80.text"));
                        panel1.add(label80);
                        label80.setBounds(new Rectangle(new Point(15, 20), label80.getPreferredSize()));

                        //---- label86 ----
                        label86.setText(bundle.getString("label86.text"));
                        panel1.add(label86);
                        label86.setBounds(new Rectangle(new Point(175, 20), label86.getPreferredSize()));
                        ...
                        panel1.add(HistoryRhostListScrollPane);
                        HistoryRhostListScrollPane.setBounds(80, 40, 80, 65);

                        //---- HTTPPortValue ----
                        HTTPPortValue.addKeyListener(new KeyAdapter() {
                            @Override
                            public void keyReleased(KeyEvent e) {
                                RhostValueKeyReleased(e);
                            }
                        });
                        HTTPPortValue.addFocusListener(new FocusAdapter() {
                            @Override
                            public void focusGained(FocusEvent e) {
                        ...
                        panel1.add(HTTPPortValue);
                        HTTPPortValue.setBounds(80, 15, 75, HTTPPortValue.getPreferredSize().height);

                        //---- LDAPPortVaule ----
                        LDAPPortVaule.addKeyListener(new KeyAdapter() {
                            @Override
                            public void keyReleased(KeyEvent e) {
                                RportVauleKeyReleased(e);
                            }
                        });
                        LDAPPortVaule.addFocusListener(new FocusAdapter() {
                            @Override
                            public void focusGained(FocusEvent e) {
                        ...
                        panel1.add(LDAPPortVaule);
                        LDAPPortVaule.setBounds(240, 15, 75, LDAPPortVaule.getPreferredSize().height);
                        ...
                        panel1.add(HistoryRportListScrollPane);
                        HistoryRportListScrollPane.setBounds(240, 40, 75, 65);

                        //---- Command ----
                        Command.setText("Command");
                        panel1.add(Command);
                        Command.setBounds(330, 20, 70, Command.getPreferredSize().height);
                        ...
                        panel1.add(CommandVaule);
                        CommandVaule.setBounds(395, 15, 95, CommandVaule.getPreferredSize().height);
                        ...
                        panel1.add(HistoryCommandListScrollPane);
                        HistoryCommandListScrollPane.setBounds(395, 40, 100, 65);

                        //---- JNDIDeserializationButton ----
                        JNDIDeserializationButton.setText(bundle.getString("JNDIDeserializationButton.text"));
                        JNDIDeserializationButton.addMouseListener(new MouseAdapter() {
                            @Override
                            public void mouseClicked(MouseEvent e) {
                                JNDIDeserializationButtonMouseClicked(e);
                            }
                        });
                        panel1.add(JNDIDeserializationButton);
                        JNDIDeserializationButton.setBounds(new Rectangle(new Point(675, 65), JNDIDeserializationButton.getPreferredSize()));

                        //---- JNDITomcatBypassButton ----
                        JNDITomcatBypassButton.setText(bundle.getString("JNDITomcatBypassButton.text"));
                        JNDITomcatBypassButton.addMouseListener(new MouseAdapter() {
                            @Override
                            public void mouseClicked(MouseEvent e) {
                                JNDITomcatBypassButtonMouseClicked(e);
                            }
                        });
                        panel1.add(JNDITomcatBypassButton);
                        JNDITomcatBypassButton.setBounds(new Rectangle(new Point(675, 15), JNDITomcatBypassButton.getPreferredSize()));

                        //---- JNDIOtherFactoryBypassButton ----
                        JNDIOtherFactoryBypassButton.setText(bundle.getString("JNDIOtherFactoryBypassButton.text"));
                        JNDIOtherFactoryBypassButton.addMouseListener(new MouseAdapter() {
                            @Override
                            public void mouseClicked(MouseEvent e) {
                                JNDIOtherFactoryBypassButtonMouseClicked(e);
                            }
                        });
                        panel1.add(JNDIOtherFactoryBypassButton);
                        JNDIOtherFactoryBypassButton.setBounds(new Rectangle(new Point(510, 65), JNDIOtherFactoryBypassButton.getPreferredSize()));

                        //---- JNDIGithubButton ----
                        JNDIGithubButton.setText(bundle.getString("JNDIGithubButton.text"));
                        JNDIGithubButton.addMouseListener(new MouseAdapter() {
                            @Override
                            public void mouseClicked(MouseEvent e) {
                                JNDIGithubButtonMouseClicked(e);
                            }
                        });
                        panel1.add(JNDIGithubButton);
                        JNDIGithubButton.setBounds(new Rectangle(new Point(625, 100), JNDIGithubButton.getPreferredSize()));
                    ...
                    tabbedPane4.addTab(bundle.getString("panel1.tab.title"), panel1);
                }
                JavaMenu.add(tabbedPane4);
                tabbedPane4.setBounds(0, 0, 895, 445);
            ...
            OptionsPanels.addTab(bundle.getString("JavaMenu.tab.title"), JavaMenu);
            ...
            //======== REs ========
            {
                ...
                //======== ResTabbedPane ========
                {
                    ...
                    //======== ReMasscanPanel ========
                    {
                        ...
                        scrollPane9.setBounds(20, 70, 360, 245);

                        //---- ReMasscanTextField ----
                        ReMasscanTextField.setText(bundle.getString("ReMasscanTextField.text"));
                        ReMasscanPanel.add(ReMasscanTextField);
                        ReMasscanTextField.setBounds(410, 65, 195, ReMasscanTextField.getPreferredSize().height);
                        ...
                        ReResetButton.setBounds(new Rectangle(new Point(15, 330), ReResetButton.getPreferredSize()));
                        ...
                        ReCopyMasscanButton.setBounds(new Rectangle(new Point(640, 65), ReCopyMasscanButton.getPreferredSize()));
                        ...
                        scrollPane19.setBounds(410, 105, 195, 210);
                        ...
                        ReIPPortCopyButton.setBounds(new Rectangle(new Point(640, 200), ReIPPortCopyButton.getPreferredSize()));
                    ...
                    //======== panel2 ========
                    {
                        ...
                        //======== scrollPane21 ========
                        {
                            ...
                            //---- ReInputValueURLTextArea ----
                            ReInputValueURLTextArea.addCaretListener(e -> ReInputValueURLTextAreaCaretUpdate(e));
                            scrollPane21.setViewportView(ReInputValueURLTextArea);
                        }
                        panel2.add(scrollPane21);
                        scrollPane21.setBounds(20, 40, 310, 355);

                        //======== scrollPane22 ========
                        {
                            scrollPane22.setViewportView(ReOuputURLTextArea);
                        }
                        panel2.add(scrollPane22);
                        scrollPane22.setBounds(475, 30, 255, 165);

                        //======== scrollPane23 ========
                        {
                            scrollPane23.setViewportView(ReOutputIPTextArea);
                        }
                        panel2.add(scrollPane23);
                        scrollPane23.setBounds(475, 230, 255, 160);

                        //---- ReIPsetButton ----
                        ReIPsetButton.setText(bundle.getString("ReIPsetButton.text"));
                        ReIPsetButton.addMouseListener(new MouseAdapter() {
                            @Override
                            public void mouseClicked(MouseEvent e) {
                                ReIPsetButtonMouseClicked(e);
                            }
                        });
                        panel2.add(ReIPsetButton);
                        ReIPsetButton.setBounds(new Rectangle(new Point(360, 215), ReIPsetButton.getPreferredSize()));

                        //---- ReURLIPresetButton ----
                        ReURLIPresetButton.setText(bundle.getString("ReURLIPresetButton.text"));
                        ReURLIPresetButton.addMouseListener(new MouseAdapter() {
                            @Override
                            public void mouseClicked(MouseEvent e) {
                                ReURLIPresetButtonMouseClicked(e);
                            }
                        });
                        panel2.add(ReURLIPresetButton);
                        ReURLIPresetButton.setBounds(new Rectangle(new Point(360, 140), ReURLIPresetButton.getPreferredSize()));

                        //---- label90 ----
                        label90.setText(bundle.getString("label90.text"));
                        panel2.add(label90);
                        label90.setBounds(new Rectangle(new Point(25, 10), label90.getPreferredSize()));

                        //---- label91 ----
                        label91.setText(bundle.getString("label91.text"));
                        panel2.add(label91);
                        label91.setBounds(new Rectangle(new Point(475, 5), label91.getPreferredSize()));

                        //---- label92 ----
                        label92.setText(bundle.getString("label92.text"));
                        panel2.add(label92);
                        label92.setBounds(new Rectangle(new Point(475, 205), label92.getPreferredSize()));

                        //---- ReOuputIPCopyButton ----
                        ReOuputIPCopyButton.setText(bundle.getString("ReOuputIPCopyButton.text"));
                        ReOuputIPCopyButton.addMouseListener(new MouseAdapter() {
                            @Override
                            public void mouseClicked(MouseEvent e) {
                                ReOuputIPCopyButtonMouseClicked(e);
                            }
                        });
                        panel2.add(ReOuputIPCopyButton);
                        ReOuputIPCopyButton.setBounds(new Rectangle(new Point(740, 295), ReOuputIPCopyButton.getPreferredSize()));

                        //---- ReOuputURLCopyButton ----
                        ReOuputURLCopyButton.setText(bundle.getString("ReOuputURLCopyButton.text"));
                        ReOuputURLCopyButton.addMouseListener(new MouseAdapter() {
                            @Override
                            public void mouseClicked(MouseEvent e) {
                                ReOuputURLCopyButtonMouseClicked(e);
                            }
                        });
                        panel2.add(ReOuputURLCopyButton);
                        ReOuputURLCopyButton.setBounds(new Rectangle(new Point(735, 90), ReOuputURLCopyButton.getPreferredSize()));
                    ...
                    ResTabbedPane.addTab(bundle.getString("panel2.tab.title"), panel2);
                }
                REs.add(ResTabbedPane);
                ResTabbedPane.setBounds(0, 0, 915, 435);
            ...
            OptionsPanels.addTab(bundle.getString("REs.tab.title"), REs);
            ...
            //======== DeCodeAndEnCodes ========
            {
                ...
                DeAndEnCodeBase64s.setBounds(0, 0, 965, 410);
            ...
            OptionsPanels.addTab(bundle.getString("DeCodeAndEnCodes.tab.title"), DeCodeAndEnCodes);
            ...
            //======== RandomMenu ========
            {
                ...
                //======== RaPasswordOptions ========
                {
                    ...
                    //======== RaPasswordpanel ========
                    {
                        ...
                        RandomTextField.setBounds(10, 80, 425, 35);
                        ...
                        PasswordLens.setBounds(new Rectangle(new Point(320, 45), PasswordLens.getPreferredSize()));

                        //---- label4 ----
                        label4.setText(bundle.getString("label4.text"));
                        RaPasswordpanel.add(label4);
                        label4.setBounds(new Rectangle(new Point(260, 50), label4.getPreferredSize()));
                        ...
                        CopyPasswordbutton.setBounds(new Rectangle(new Point(455, 85), CopyPasswordbutton.getPreferredSize()));
            ...
            OptionsPanels.addTab(bundle.getString("RandomMenu.tab.title"), RandomMenu);
            ...
            OptionsPanels.addTab(bundle.getString("CustomEditMenu.tab.title"), CustomEditMenu);
        }
        contentPane.add(OptionsPanels);
        OptionsPanels.setBounds(0, 145, 925, 475);
        ...
        //======== ButtonPanel ========
        {
            ...
            ButtonPanel.add(ipLongRenewButton);
            ipLongRenewButton.setBounds(new Rectangle(new Point(360, 5), ipLongRenewButton.getPreferredSize()));
            ...
            ButtonPanel.add(ipLongSettingButton);
            ipLongSettingButton.setBounds(new Rectangle(new Point(280, 5), ipLongSettingButton.getPreferredSize()));
            ...
            ButtonPanel.add(Delectbutton);
            Delectbutton.setBounds(new Rectangle(new Point(90, 5), Delectbutton.getPreferredSize()));
            ...
            saveMenuButton.setBounds(new Rectangle(new Point(5, 5), saveMenuButton.getPreferredSize()));

            //---- label73 ----
            label73.setText(bundle.getString("label73.text"));
            ButtonPanel.add(label73);
            label73.setBounds(new Rectangle(new Point(190, 10), label73.getPreferredSize()));
        ...
        ButtonPanel.setBounds(10, 5, 705, 40);
        ...
        //======== WastePanel ========
        {
            ...
            //---- RPORT ----
            RPORT.setText("RPORT");
            WastePanel.add(RPORT);
            RPORT.setBounds(175, 55, 55, RPORT.getPreferredSize().height);

            //---- RHOST ----
            RHOST.setText(bundle.getString("RHOST.text"));
            WastePanel.add(RHOST);
            RHOST.setBounds(10, 35, 55, RHOST.getPreferredSize().height);

            {
                // compute preferred size
                Dimension preferredSize = new Dimension();
                for(int i = 0; i < WastePanel.getComponentCount(); i++) {
                    Rectangle bounds = WastePanel.getComponent(i).getBounds();
                    preferredSize.width = Math.max(bounds.x + bounds.width, preferredSize.width);
                    preferredSize.height = Math.max(bounds.y + bounds.height, preferredSize.height);
                }
                Insets insets = WastePanel.getInsets();
                preferredSize.width += insets.right;
                preferredSize.height += insets.bottom;
                WastePanel.setMinimumSize(preferredSize);
                WastePanel.setPreferredSize(preferredSize);
            }
        }
    ...
    public JPanel inputValuePanels;
    ...
    private JTabbedPane OptionsPanels;
    ...
    private JTextField BashTCP4TextField;
    private JButton BashTCP4Button;
    ...
    private JTextField Python2ServerTextField;
    private JLabel label88;
    private JTextField Python3ServerTextField;
    private JPanel CurlOptionsPanel;
    ...
    private JTextField CatListenerTextField;
    private JLabel label93;
    private JLabel label94;
    private JTextField CatAttackTextField;
    ...
    private JTextArea JNDValueITextArea;
    private JButton JNDIJavaBytecodeExecButton;
    private JTextField JNDIExploitTextField;
    ...
    private JTextField HTTPPortValue;
    private JTextField LDAPPortVaule;
    ...
    private JButton JNDIDeserializationButton;
    private JButton JNDITomcatBypassButton;
    private JButton JNDIOtherFactoryBypassButton;
    private JButton JNDIGithubButton;
    private JPanel REs;
    ...
    private JTextArea ReInputValueURLTextArea;
    private JScrollPane scrollPane22;
    private JTextArea ReOuputURLTextArea;
    private JScrollPane scrollPane23;
    private JTextArea ReOutputIPTextArea;
    private JButton ReIPsetButton;
    private JButton ReURLIPresetButton;
    private JLabel label90;
    private JLabel label91;
    private JLabel label92;
    private JButton ReOuputIPCopyButton;
    private JButton ReOuputURLCopyButton;
